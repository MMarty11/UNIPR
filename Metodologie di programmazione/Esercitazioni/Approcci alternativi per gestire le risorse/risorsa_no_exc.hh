...
// puntatore perché non so cosa c'è all'interno della risorsa, quindi non posso restituire per valore
...
//non può fallire, dovrebbe sempre garantire il livello più alto di exception safety
